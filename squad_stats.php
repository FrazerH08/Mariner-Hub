...
<head>
    ...
    <link rel="stylesheet" href="squad_stats.css">
     <style>
...
<body>
    ...
    <a class="btn" href="league_2_stats_only.php">League 2 24/25 Stats ONLY </a>
...
<div class="grid-container">
  ...
  <div><b>Goals:</b></div>
  <div><b>Assists:</b></div>
  <div><b>Yellow Cards:</b></div>
  <div><b>Red Cards:</b></div>
  <div><b>Actions:</b></div>
  <div>1</div>  
  ...
  <div>4</div>
  <div>0</div>
  <div> <a href="cameron-mcjannett.php">View Profile</a></div>
    <div>18</div>  
  <div>Darragh Burns</div>
  <div>9</div>
  <div>0</div> 
  <div>0</div> 
  <div>1</div>
  <div>0</div>
  <div> <a href="darragh-burns.php">View Profile</a></div>
    <div>19</div>  
  <div>Géza Dávid Turi</div>
  <div>4</div>
  <div>0</div> 
  <div>0</div> 
  <div>1</div>
